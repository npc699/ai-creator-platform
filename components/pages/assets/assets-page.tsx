...
import { AssetAddPanel, AssetGrid, type AssetListItem } from "@/components/assets";
import type { EditorAsset } from "@/lib/client/assets/api";
...
/** 素材库主体：顶栏 + 上传面板 + 素材网格。 */
export function AssetsPage({ initialItems }: AssetsPageProps) {
