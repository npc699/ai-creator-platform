...
import { ArticleMetaBadges } from "./meta-badges";
import { AuthorProfileLink } from "@/components/author";
import { FeedCardCover } from "./card-cover";
import { saveFeedScrollPosition } from "./scroll-restore";
...
import { useFeedLikeToggle } from "./use-like-toggle";
...
// ─── FeedArticleRow / FeedArticleList ────────────────────────────

export type FeedArticleRowProps = HomeFeedListItemProps;

/** FeedArticleItem → 列表行 props 边界；已发布/草稿列表共用。 */
export function FeedArticleRow(props: FeedArticleRowProps) {
