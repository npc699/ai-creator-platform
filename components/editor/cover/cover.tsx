...
import { FolderOpen, ImageIcon, RefreshCw, Sparkles, Square, Trash2, Upload, X } from "lucide-react";
...
import { persistRemoteEditorImage, uploadEditorImage } from "@/lib/editor/image/upload";
...
function EditorCoverDialog({ onClose }: EditorCoverDialogProps) {
