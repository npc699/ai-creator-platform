...
type MediaResolutionPickerProps = {
  value: AiImageSize;
...
export function MediaResolutionPicker({
  value,
  onChange,
  disabled = false,
...
/** @deprecated 使用 MediaResolutionPicker */
export const ImageResolutionPicker = MediaResolutionPicker;
