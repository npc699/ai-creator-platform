...
/** @deprecated 使用 MediaAccordion */
export const AssetLibraryAccordion = MediaAccordion;

type MediaValidationStatusProps = {
  ok: boolean;
  message: string;
};

export function MediaValidationStatus({ ok, message }: MediaValidationStatusProps) {
  return (
    <p
      className={cn(
...
/** @deprecated 使用 MediaValidationStatus */
export const AssetLibraryValidationStatus = MediaValidationStatus;
