...
function ReaderAuthorActions({
  ...
  // props 变化时在 render 阶段同步，避免 effect setState。
...
export function ReaderHeader({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 border-b border-zinc-200/80 px-4 py-3">
      ...
      {showAuthorActions ? (
        <ReaderAuthorActions postId={postId} status={status} />
      ) : null}
    </div>
  );
}

/** @deprecated 使用 ReaderHeader */
export const PostReaderHeader = ReaderHeader;
